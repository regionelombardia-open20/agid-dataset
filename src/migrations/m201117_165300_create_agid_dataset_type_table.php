...
class m201117_165300_create_agid_dataset_type_table extends Migration
{

    public function up()
    {
   
        $this->createTable('agid_dataset_type', [
    ...
    public function down()
    {
       ...
       // Drop Table agid_dataset_type
       $this->dropTable('agid_dataset_type');
    }
}
